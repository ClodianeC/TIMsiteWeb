...
{{--  https://developers.google.com/chart/interactive/docs/gallery/piechart  --}}
    ...
    <div class="infoSuppProgramme">
        ...
        <div class="infoSuppProgramme__boutons">
            <button class="btnPrincipal infoSuppProgramme__boutons__btnSiteCegep">Visite le site web du Cégep de Sainte-Foy</button>
            <div class="infoSuppProgramme__boutons__ou"><p class="infoSuppProgramme__boutons__ou__texte">OU</p></div>
            <button class="btnSecondaire infoSuppProgramme__boutons_btnTelechargerGrille">Télécharge la grille du cours</button>
        </div>
    </div>
